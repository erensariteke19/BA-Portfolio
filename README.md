# İş Analisti | Gereksinim, Süreç ve Sistem Analizi

Merhaba, ben **Eren Sarıteke**. Operasyonel ve teknik ihtiyaçları açık gereksinimlere, modellenmiş süreçlere, yapılandırılmış dokümantasyona ve test edilebilir sistem davranışlarına dönüştüren bir İş Analistiyim.
...
| Kurum ve rol | Dönem | İş analizi odağı |
|---|---|---|
| **Marser Otomasyon — İş Analisti** | Ekim 2025 – Temmuz 2026 | Operasyonel ve teknik gereksinimler, süreç değerlendirme, User Story/Use Case, HMI fonksiyonel testleri, teknik dokümantasyon ve ekipler arası koordinasyon |
| **Kloia Yazılım — Frontend Developer Stajyeri** | Temmuz 2025 – Ağustos 2025 | Kullanıcı arayüzü geliştirme, hata düzeltme, kod iyileştirme ve Git/GitHub üzerinden değişiklik yönetimi |

[Profesyonel deneyim ve yetkinlik bağlantılarını incele](EXPERIENCE.md)
...
`SQL Server / SSMS` · `Postman` · `Swagger` · `FastAPI` · `Jira` · `Git/GitHub` · `Visual Studio Code` · `Microsoft Office` · `TIA Portal`

## Teknik alan bilgisi

`PLC ve Ladder Logic` · `HTML/CSS/JavaScript` · `HMI` · `Endüstriyel otomasyon` · `AutoCAD` · `SolidWorks`
