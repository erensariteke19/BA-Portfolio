...
Bu bölüm, iş gereksinimlerini kullanıcı akışlarına, ekran davranışlarına ve geliştirme/QA tarafından uygulanabilir fonksiyonel UI kurallarına dönüştürme çalışmalarımı gösterir. Teknik referans arayüzü **HTML, CSS ve JavaScript** kullanır.
...
## Gereksinim bağlantılı ekran tasarımları
...
## Teknik referans arayüzü

ErenShop teknik ortamında mağaza, API/SQL dokümantasyonu ve analiz çalışma ekranları bulunur:

- [Mağaza ekranı](../01-erenshop-business-analysis/05-learning-platform/frontend/index.html)
- [Analiz çalışma ekranı](../01-erenshop-business-analysis/05-learning-platform/frontend/training.html)
...
Bu portföyde iş analizi senaryoları, gereksinimler, kabul kriterleri, wireframe'ler ve UI fonksiyonel spesifikasyonu Eren Sarıteke tarafından hazırlanmıştır. Teknik referans arayüzünün kaynak bilgisi proje [CREDITS](../01-erenshop-business-analysis/CREDITS.md) dosyasında yer alır.
